...
var MultiPicker = (function () {
    ...
    MultiPicker.prototype.updateText = function () {
        ...
        this.multiPickerColumns.forEach(function (col, index) {
            ...
            if (option) {
                _this.placeholderText += "" + option.text;
                if (index < _this.multiPickerColumns.length - 1) {
                    _this.placeholderText += "" + _this.separator;
                }
            }
        });
        this.placeholderText = this.placeholderText.trim();
        this._text = this.placeholderText;
    };
...
MultiPicker.decorators = [
    { type: core_1.Component, args: [{
                ...
                template: '<div class="multi-picker-text">{{placeholderText}}</div>' +
...
MultiPicker.propDecorators = {
    ...
    'placeholderText': [{ type: core_1.Input },],
